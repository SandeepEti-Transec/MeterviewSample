namespace MeterView.Devices.API.IntegrationTests;

using MeterView.Devices.API.Extensions.Services;
using MeterView.Devices.API.Databases;
using MeterView.Devices.API.Resources;
using MeterView.Devices.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewDevicesAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewDevicesAPIKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<DevicesDbContext>()
            ...
            .Options;
        var context = new DevicesDbContext(options, null, null, null);
