...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<DevicesDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<DevicesDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<DevicesDbContext, Task<T>> action)
