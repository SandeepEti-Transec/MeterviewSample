namespace MeterView.Devices.API.SharedTestHelpers.Fakes.Address;

using MeterView.Devices.API.Domain.Addresses.Dtos;
using MeterView.Devices.API.Domain.Addresses;
