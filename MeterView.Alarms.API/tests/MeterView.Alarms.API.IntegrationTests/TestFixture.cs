namespace MeterView.Alarms.API.IntegrationTests;

using MeterView.Alarms.API.Extensions.Services;
using MeterView.Alarms.API.Databases;
using MeterView.Alarms.API.Resources;
using MeterView.Alarms.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewAlarmsAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewAlarmsAPIKey] = _dbContainer.GetConnectionString();
    ...
    {
        var options = new DbContextOptionsBuilder<AlarmsDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new AlarmsDbContext(options, null, null, null);
