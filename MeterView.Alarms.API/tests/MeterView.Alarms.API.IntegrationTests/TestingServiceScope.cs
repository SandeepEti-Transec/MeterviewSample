...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<AlarmsDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<AlarmsDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<AlarmsDbContext, Task<T>> action)
