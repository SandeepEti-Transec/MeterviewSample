namespace MeterView.Alarms.API.SharedTestHelpers.Fakes.Address;

using MeterView.Alarms.API.Domain.Addresses.Dtos;
using MeterView.Alarms.API.Domain.Addresses;
