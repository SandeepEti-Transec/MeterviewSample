namespace MeterView.Alarms.API.Databases;

using MeterView.Alarms.API.Domain;
using MeterView.Alarms.API.Databases.EntityConfigurations;
...
public sealed class AlarmsDbContext(DbContextOptions<AlarmsDbContext> options, 
