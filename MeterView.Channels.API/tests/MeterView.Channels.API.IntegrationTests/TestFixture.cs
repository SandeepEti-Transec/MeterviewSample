namespace MeterView.Channels.API.IntegrationTests;

using MeterView.Channels.API.Extensions.Services;
using MeterView.Channels.API.Databases;
using MeterView.Channels.API.Resources;
using MeterView.Channels.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewChannelsAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewChannelsAPIKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<ChannelsDbContext>()
            ...
            .Options;
        var context = new ChannelsDbContext(options, null, null, null);
