...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<ChannelsDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<ChannelsDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<ChannelsDbContext, Task<T>> action)
