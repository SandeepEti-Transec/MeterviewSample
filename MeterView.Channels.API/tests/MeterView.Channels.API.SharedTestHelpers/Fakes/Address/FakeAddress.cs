namespace MeterView.Channels.API.SharedTestHelpers.Fakes.Address;

using MeterView.Channels.API.Domain.Addresses.Dtos;
using MeterView.Channels.API.Domain.Addresses;
