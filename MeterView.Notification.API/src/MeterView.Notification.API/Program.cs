...
using MeterView.Notification.API.Extensions.Application;
using MeterView.Notification.API.Extensions.Services;
using MeterView.Notification.API.Databases;
using MeterView.Notification.API.Resources.HangfireUtilities;
...
app.UseCors("MeterView.Notification.APICorsPolicy");
