namespace MeterView.Notification.API.IntegrationTests;

using MeterView.Notification.API.Extensions.Services;
using MeterView.Notification.API.Databases;
using MeterView.Notification.API.Resources;
using MeterView.Notification.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewNotificationAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewNotificationAPIKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<NotificationDbContext>()
            ...
            .Options;
        var context = new NotificationDbContext(options, null, null, null);
