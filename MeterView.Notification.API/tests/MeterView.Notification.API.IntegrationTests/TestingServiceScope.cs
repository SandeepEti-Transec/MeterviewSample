...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<NotificationDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<NotificationDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<NotificationDbContext, Task<T>> action)
