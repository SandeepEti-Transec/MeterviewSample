namespace MeterView.Notification.API.SharedTestHelpers.Fakes.Address;

using MeterView.Notification.API.Domain.Addresses.Dtos;
using MeterView.Notification.API.Domain.Addresses;
