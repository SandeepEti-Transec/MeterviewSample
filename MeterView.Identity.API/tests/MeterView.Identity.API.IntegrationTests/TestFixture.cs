namespace MeterView.Identity.API.IntegrationTests;

using MeterView.Identity.API.Extensions.Services;
using MeterView.Identity.API.Databases;
using MeterView.Identity.API.Resources;
using MeterView.Identity.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewIdentityAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewIdentityAPIKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<IdentityDbContext>()
            ...
            .Options;
        var context = new IdentityDbContext(options, null, null, null);
