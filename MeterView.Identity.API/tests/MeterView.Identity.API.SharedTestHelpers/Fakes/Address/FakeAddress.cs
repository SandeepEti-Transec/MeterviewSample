namespace MeterView.Identity.API.SharedTestHelpers.Fakes.Address;

using MeterView.Identity.API.Domain.Addresses.Dtos;
using MeterView.Identity.API.Domain.Addresses;
