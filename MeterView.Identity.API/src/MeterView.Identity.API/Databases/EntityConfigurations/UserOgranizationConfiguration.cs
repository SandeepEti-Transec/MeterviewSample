namespace MeterView.Identity.API.Databases.EntityConfigurations;

using MeterView.Identity.API.Domain.UserOgranizations;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public sealed class UserOgranizationConfiguration : IEntityTypeConfiguration<UserOgranization>
{
    /// <summary>
    /// The database configuration for UserOgranizations. 
    /// </summary>
    public void Configure(EntityTypeBuilder<UserOgranization> builder)
    {
