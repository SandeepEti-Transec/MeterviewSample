namespace MeterView.Identity.API.Databases;

using MeterView.Identity.API.Domain;
using MeterView.Identity.API.Databases.EntityConfigurations;
    ...
    : DbContext(options)
{
    ...
    public DbSet<UserOgranization> UserOgranizations { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new UserOgranizationConfiguration());
