...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<ScreenRenderingDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<ScreenRenderingDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<ScreenRenderingDbContext, Task<T>> action)
