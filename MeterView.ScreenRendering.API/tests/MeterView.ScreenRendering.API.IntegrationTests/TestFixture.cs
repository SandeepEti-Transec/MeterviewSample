namespace MeterView.ScreenRendering.API.IntegrationTests;

using MeterView.ScreenRendering.API.Extensions.Services;
using MeterView.ScreenRendering.API.Databases;
using MeterView.ScreenRendering.API.Resources;
using MeterView.ScreenRendering.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewScreenRenderingAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewScreenRenderingAPIKey] = _dbContainer.GetConnectionString();
    ...
    {
        var options = new DbContextOptionsBuilder<ScreenRenderingDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new ScreenRenderingDbContext(options, null, null, null);
