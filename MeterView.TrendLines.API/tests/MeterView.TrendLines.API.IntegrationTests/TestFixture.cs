namespace MeterView.TrendLines.API.IntegrationTests;

using MeterView.TrendLines.API.Extensions.Services;
using MeterView.TrendLines.API.Databases;
using MeterView.TrendLines.API.Resources;
using MeterView.TrendLines.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewTrendLinesAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewTrendLinesAPIKey] = _dbContainer.GetConnectionString();
    ...
    {
        var options = new DbContextOptionsBuilder<TrendLinesDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new TrendLinesDbContext(options, null, null, null);
