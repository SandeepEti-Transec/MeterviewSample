...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<TrendLinesDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<TrendLinesDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<TrendLinesDbContext, Task<T>> action)
