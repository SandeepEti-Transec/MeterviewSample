namespace MeterView.TrendLines.API.Databases.EntityConfigurations;

using MeterView.TrendLines.API.Domain.TrendLines;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public sealed class TrendLineConfiguration : IEntityTypeConfiguration<TrendLine>
{
    /// <summary>
    /// The database configuration for TrendLines. 
    /// </summary>
    public void Configure(EntityTypeBuilder<TrendLine> builder)
    {
