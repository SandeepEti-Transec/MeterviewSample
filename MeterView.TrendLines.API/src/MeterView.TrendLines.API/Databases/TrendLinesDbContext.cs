namespace MeterView.TrendLines.API.Databases;

using MeterView.TrendLines.API.Domain;
using MeterView.TrendLines.API.Databases.EntityConfigurations;
...
public sealed class TrendLinesDbContext(DbContextOptions<TrendLinesDbContext> options, 
    ...
    : DbContext(options)
{
    ...
    public DbSet<TrendLine> TrendLines { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new TrendLineConfiguration());
