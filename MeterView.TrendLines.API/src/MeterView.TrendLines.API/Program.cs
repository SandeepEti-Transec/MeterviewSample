...
using MeterView.TrendLines.API.Extensions.Application;
using MeterView.TrendLines.API.Extensions.Services;
using MeterView.TrendLines.API.Databases;
using MeterView.TrendLines.API.Resources.HangfireUtilities;
...
app.UseCors("MeterView.TrendLines.APICorsPolicy");
