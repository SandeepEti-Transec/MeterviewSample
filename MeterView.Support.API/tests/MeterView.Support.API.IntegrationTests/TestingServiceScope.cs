...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<SupportDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<SupportDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<SupportDbContext, Task<T>> action)
