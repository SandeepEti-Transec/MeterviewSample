namespace MeterView.Support.API.SharedTestHelpers.Fakes.Address;

using MeterView.Support.API.Domain.Addresses.Dtos;
using MeterView.Support.API.Domain.Addresses;
