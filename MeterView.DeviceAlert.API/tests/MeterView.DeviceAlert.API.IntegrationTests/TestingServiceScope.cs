...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<DeviceAlertDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<DeviceAlertDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<DeviceAlertDbContext, Task<T>> action)
