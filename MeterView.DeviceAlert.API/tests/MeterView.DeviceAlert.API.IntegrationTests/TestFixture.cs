namespace MeterView.DeviceAlert.API.IntegrationTests;

using MeterView.DeviceAlert.API.Extensions.Services;
using MeterView.DeviceAlert.API.Databases;
using MeterView.DeviceAlert.API.Resources;
using MeterView.DeviceAlert.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewDeviceAlertAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewDeviceAlertAPIKey] = _dbContainer.GetConnectionString();
    ...
    {
        var options = new DbContextOptionsBuilder<DeviceAlertDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new DeviceAlertDbContext(options, null, null, null);
