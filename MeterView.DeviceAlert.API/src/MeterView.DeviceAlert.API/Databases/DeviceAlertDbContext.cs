namespace MeterView.DeviceAlert.API.Databases;

using MeterView.DeviceAlert.API.Domain;
using MeterView.DeviceAlert.API.Databases.EntityConfigurations;
...
public sealed class DeviceAlertDbContext(DbContextOptions<DeviceAlertDbContext> options, 
    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new DeviceAlertConfiguration());
