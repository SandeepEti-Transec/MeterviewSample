namespace MeterView.DeviceAlert.API.Databases.EntityConfigurations;

using MeterView.DeviceAlert.API.Domain.DeviceAlerts;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public sealed class DeviceAlertConfiguration : IEntityTypeConfiguration<DeviceAlert>
{
    /// <summary>
    /// The database configuration for DeviceAlerts. 
    /// </summary>
