namespace MeterView.Reporting.API.SharedTestHelpers.Fakes.Address;

using MeterView.Reporting.API.Domain.Addresses.Dtos;
using MeterView.Reporting.API.Domain.Addresses;
