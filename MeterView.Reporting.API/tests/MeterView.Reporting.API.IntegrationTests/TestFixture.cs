namespace MeterView.Reporting.API.IntegrationTests;

using MeterView.Reporting.API.Extensions.Services;
using MeterView.Reporting.API.Databases;
using MeterView.Reporting.API.Resources;
using MeterView.Reporting.API.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.MeterViewReportingAPIOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.MeterViewReportingAPIKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<ReportingDbContext>()
            ...
            .Options;
        var context = new ReportingDbContext(options, null, null, null);
