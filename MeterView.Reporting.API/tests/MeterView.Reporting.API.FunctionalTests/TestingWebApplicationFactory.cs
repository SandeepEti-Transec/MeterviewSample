namespace MeterView.Reporting.API.FunctionalTests;
...
public class TestingWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Environment.SetEnvironmentVariable($"{ConnectionStringOptions.SectionName}__{ConnectionStringOptions.MeterViewReportingAPIKey}", _dbContainer.GetConnectionString());
